     ...
     <div className='wrapper-home'>
        ...
        <div className='second-section'>
          <div className='home-ojt'>
            ...
            <p>is a practical approach to acquiring new competencies and skills needed for a job in a real, or close to a real, working environment.
            </p>
            <p>It is often used to learn how to use particular tools or equipment in a live-work practice, simulated, or training environment.
            </p>
            </div>
          ...
          <div className='home-ojt-adviser'>
